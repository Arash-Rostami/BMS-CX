...
class CaseSummary extends Component
{
    ...
    private function calculateTotalPaymentRequests($proforma)
    {
        ...
        $proforma->associatedPaymentRequests->whereNull('deleted_at')->each(function ($pr) use (&$totals) {
    ...
    private function calculateTotalPayments($proforma)
    {
        ...
        $proforma->associatedPaymentRequests->flatMap->payments->whereNull('deleted_at')->each(function ($payment) use (&$totals) {
    ...
    {
        return view('livewire.case-summary');
    }
