...
use App\Filament\Pages\Trait\LoanSummaryStats as LoanSummaryStatsTrait;
use App\Livewire\ClientPortal\LoanTable;
use Filament\Widgets\Concerns\InteractsWithPageTable;
use Filament\Widgets\StatsOverviewWidget as BaseWidget;
use Filament\Widgets\StatsOverviewWidget\Stat;

class LoanSummaryStats extends BaseWidget
{
...
//    protected static ?string $pollingInterval = null;
    ...
    {
        $stats = $this->prepareLoanSummaryStats($this->getPageTableQuery());
