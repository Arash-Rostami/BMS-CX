...
namespace App\Filament\Resources\Financial\BalanceResource\Pages;
    ...
    public static function getRecipient(): Select
    {
        return Select::make('category_id')
            ...
            ->options(function (Get $get) {
                ...
                $list = SmartCacheManager::remember($category, ['type' => 'select_options'], 720, function () use ($category) {
                    $model = match ($category) {
                        'suppliers' => Supplier::class,
                        'contractors' => Contractor::class,
                        'payees' => Beneficiary::class,
                        default => null,
                    };
                    return $model ? $model::pluck('name', 'id')->all() : [];
                });
