...
trait PaymentComputations
{
    ...
    protected function processPaymentRequest(PaymentRequest $paymentRequest, string $action): void
    {
        ...
        foreach ($categories as $category => $categoryId) {
            ...
            match ($action) {
                'update' => $this->updateOrCreateBalance($category, $categoryId, $paymentRequest),
                'delete' => $this->deleteBalance($category, $categoryId),
                'restore' => $this->restoreBalance($category, $categoryId, $paymentRequest),
                default => null,
            };
        }
    }
