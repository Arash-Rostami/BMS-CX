...
class ShippingLineBotTable
{
    ...
    {
        return $this->bp->fetchAllTableRows('ShippingLineTable');
    }
    ...
    {
        return $this->bp->deleteAllTableRows('ShippingLineTable');
    }
}
