        ...
        <ul class="nav nav-tabs flex border-b">
            <li class="nav-item">
                <button @click="activeTab = 'proforma-summary'"
                        :class="activeTab === 'proforma-summary' ? 'nav-link bg-blue-500 text-white' : 'nav-link bg-gray-200'">
                    Contract Summary
                </button>
            </li>
            <li class="nav-item">
                <button @click="activeTab = 'supplier-summary'"
                        :class="activeTab === 'supplier-summary' ? 'nav-link bg-blue-500 text-white' : 'nav-link bg-gray-200'">
                    Supplier Summary
                </button>
            </li>
        </ul>
        ...
        @if ($selectedProforma)
            ...
            <div x-show="activeTab === 'supplier-summary'" class="tab-pane p-4">
                <div class="livewire-supplier-summary">
                    ...
                    'wire:key' => "supplier-summary-{$selectedProforma->supplier_id}"
                    ])
                </div>
            </div>
        @endif
