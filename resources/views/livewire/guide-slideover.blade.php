@php
    $workflows = [
        ['id'=>'w1','title'=>'Dashboard',        'pdf'=>'/guides/dashboard.pdf',      'video'=>'/guides/media/dashboard.mp4',      'info'=>'/guides/media/dashboard.png',      'mindmap'=>'/guides/media/dashboard_map.png',   'quiz'=>'https://notebooklm.google.com/notebook/91c1c316-f5e2-4813-b37b-f7719f6d116a/artifact/e831f074-d595-4dfe-9064-bbfa86303d0b?utm_source=nlm_web_share&utm_medium=google_oo&utm_campaign=art_share_1&utm_content=&utm_smc=nlm_web_share_google_oo_art_share_1_'],
        ['id'=>'w2','title'=>'Case Summary',     'pdf'=>'/guides/caseSummary.pdf',    'video'=>'/guides/media/caseSummary.mp4',    'info'=>'/guides/media/caseSummary.png',    'mindmap'=>'/guides/media/caseSummary_map.png', 'quiz'=>'https://notebooklm.google.com/notebook/bdd32db3-2ccd-48b3-bc06-6403ff2e7340/artifact/34e5dec2-39af-4dd9-a203-53a04d2ae57e?utm_source=nlm_web_share&utm_medium=google_oo&utm_campaign=art_share_1&utm_content=&utm_smc=nlm_web_share_google_oo_art_share_1_'],
        ['id'=>'w3','title'=>'Payment Requests', 'pdf'=>'/guides/paymentRequest.pdf', 'video'=>'/guides/media/paymentRequest.mp4', 'info'=>'/guides/media/paymentRequest.png', 'mindmap'=>'/guides/media/paymentRequest_map.png','quiz'=>'https://notebooklm.google.com/notebook/99bf2f4e-a3e1-42d2-a60a-caadcf58f936/artifact/8c796b7f-932f-4ba8-ab06-28ab07e43e6b?utm_source=nlm_web_share&utm_medium=google_oo&utm_campaign=art_share_1&utm_content=&utm_smc=nlm_web_share_google_oo_art_share_1_'],
        ['id'=>'w4','title'=>'Master Data',      'pdf'=>'/guides/masterData.pdf',     'video'=>'/guides/media/masterData.mp4',     'info'=>'/guides/media/masterData.png',     'mindmap'=>'/guides/media/masterData_map.png',  'quiz'=>'https://notebooklm.google.com/notebook/1e5a1c4c-7f62-4068-a885-7aa7aa81e7e3/artifact/0c07bfa2-2fde-4e39-9fe6-378ecc30f213?utm_source=nlm_web_share&utm_medium=google_oo&utm_campaign=art_share_1&utm_content=&utm_smc=nlm_web_share_google_oo_art_share_1_'],
    ];
    ...
    <template x-if="src && type === 'video'">
        <div
            ...
            <video :src="src" controls autoplay @dblclick="fs = !fs"
                   :class="fs ? 'fixed inset-0 z-[9999] w-screen h-screen object-contain bg-black cursor-zoom-out' : 'w-full h-full object-contain cursor-zoom-in'"/>
        </div>
    </template>
